...
def main(args: argparse.Namespace) -> int:
    ...
    my_dict = torch.load(args.merge_dict_path) if args.merge_dict_path else None
...
def get_args_parser():
    ...
    parser.add_argument("--loss_weight_mode", type=str, default="sizes",
                        choices=["sizes", "scalar", "none"],
                        help="Loss weight mode: 'sizes' = sizes[k]*K/N (current), "
                             "'scalar' = K/N only, 'none' = no loss weight")
