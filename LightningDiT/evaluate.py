"""Evaluate the XL LightningDiT latent model with optional CFG grid search."""
...
def main(args: argparse.Namespace) -> int:
    ...
    if not args.merge_dict_path:
        raise ValueError("--merge_dict_path is required for refined LightningDiT evaluation")
    ...
    ckpt_resume(args, model_wo_ddp, None, loss_scaler, ema_model)
...
def get_args_parser():
    ...
    parser.add_argument("--timestep_shift", type=float, default=0.2)
    ...
    parser.add_argument("--merge_dict_path", default=path_value("paths", "merge_dict"), type=str, help="path to pre-computed merge assignment dict")
