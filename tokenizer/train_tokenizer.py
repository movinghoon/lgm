...
def main(args):
    ...
    vq_model = VQ_models[args.vq_model](
        ...
        merge_dim=args.merge_dim,
        vf_loss_weight=args.vf_loss_weight,
        vf_margin=args.vf_margin,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--perceptual-warmup", type=float, default=None, help="iteration to warmup perceptual loss")
    ...
    parser.add_argument("--lr_warmup_epochs", type=float, default=1)
    ...
    parser.add_argument("--vf-loss-weight", type=float, default=1.0, help='weight for vf_loss in ours2')
    parser.add_argument("--vf-margin", type=float, default=0.25, help='margin for vf_loss hinge in ours2')
